...
for code in sorted([*codes]):
    print(code)
lines = codes['080']
print(f"{round(lines*100/len(bangaloreCodes),2)} percent of calls from fixed lines in Bangalore are calls to other fixed lines in Bangalore.")